...
### 21.6 Scope of This Alignment

This section establishes a conceptual mapping, not an implementation commitment. Landos is not adopting LADM as a schema, a data format, or a dependency. The value is translational: Landos's existing classes already do what LADM's core classes describe, and naming that correspondence makes Landos legible to the land administration field without changing anything about how Landos works.
...
- `landos-design-v0.1.6.md` — previous version (in GitHub repo)
...
- LADM (Land Administration Domain Model, ISO 19152) — international standard for land administration; Edition II Part 1 (2024, generic conceptual model), Part 2 (2025, land registration), Part 3 (2024, marine georegulation), Part 5 (2025, spatial plan information / 3D spatial units)

---

*End of v0.1.7 — this is a thinking document, not a final design. All sections subject to change.*
